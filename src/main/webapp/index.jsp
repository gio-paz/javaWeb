...
<body style="background-color: #f5f5f5;">
	...
	<div class="container">
		<div class="card mt-5">
			<div class="card-body">
				<form id="fromi" class="formulario" action="get" method="post">
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Numero de telefono" required>
					</div>
